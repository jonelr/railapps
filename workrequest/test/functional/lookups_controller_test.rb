...
class LookupsControllerTest < ActionController::TestCase
  ...
  test "should create lookup" do
    assert_difference('Lookup.count') do
      post :create, lookup: { lookup_key: @lookup.lookup_key, lookup_name: @lookup.lookup_name, lookup_value: @lookup.lookup_value }
    end
  ...
  test "should update lookup" do
    put :update, id: @lookup, lookup: { lookup_key: @lookup.lookup_key, lookup_name: @lookup.lookup_name, lookup_value: @lookup.lookup_value }
    assert_redirected_to lookup_path(assigns(:lookup))
  end
